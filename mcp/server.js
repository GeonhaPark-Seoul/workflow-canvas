...
- stage: 기본 약 220×90px (최소 200×80). memo: 기본 약 180×90px (최소 160×80).
...
### 리치 텍스트
label/description/header/text는 HTML을 지원합니다 (렌더링됨). 허용 태그: b, strong, i, em, u, s, font(color/size), span, div, p, br, ul, ol, li, details, summary, input(checkbox), img(data:image), a(https).
