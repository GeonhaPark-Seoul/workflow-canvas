...
export const WORKFLOW_CANVAS_SOURCE_PROFILE = defineSourceProfile({
  ...
  capabilities: ['file-structure', 'javascript-ast', 'sql-declarations', 'curated-file-roles', 'product-area-classification', 'feature-boundary-classification', 'component-catalog', 'module-asset-candidates', 'code-part-translation', 'static-flow-discovery', 'registered-property-roundtrip'],
  languageSupport: [
  ...
  featureModel: {
    ...
    decisions: [
      ...
      { scope: 'subsystem', id: 'twin-discovery', classification: 'capability', rationale: '디지털 트윈 기능 안에서 구성요소 발견 능력을 노출합니다.' },
      { scope: 'subsystem', id: 'twin-materialization', classification: 'capability', rationale: '디지털 트윈 기능 안에서 승인된 지도 실체화 능력을 노출합니다.' },
      { scope: 'subsystem', id: 'twin-operations', classification: 'capability', rationale: '디지털 트윈 기능 안에서 안전한 조작 수명주기를 노출합니다.' },
    ...
    implementationRules: [
      ...
      { pathPattern: '^(?:shared/sourceAiExplanation\\.js|api/source-twin\\.js)$', targetEntityId: 'map-component-source-ai-explanation' },
      { pathPattern: '^(?:shared/(?:sourceEditableProperties|workflowSourceEditableProperties)\\.js|scripts/source-edit-executor\\.mjs|mcp/localConnectorStore\\.js)$', targetEntityId: 'map-component-source-roundtrip-editor' },
      { pathPattern: '^(?:shared/sourceTwin|src/components/SourceTwinPanel)', targetEntityId: 'map-engine-source-lens' },
