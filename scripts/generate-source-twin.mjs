...
const builtManifest = buildSourceTwinManifest(readSourceTwinWorkingTree(root), {
  previous,
  repository: readSourceRepositoryMetadata(root),
  includeCodePartCatalog: true,
  includeFlowCatalog: true,
})
const { codePartCatalog, flowCatalog, ...manifest } = builtManifest
...
if (checkOnly) {
  ...
  if (prepared === existing && featureGenerated === featureExisting && codePartGenerated === codePartExisting && flowGenerated === flowExisting) {
