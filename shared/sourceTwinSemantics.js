...
export const SOURCE_TWIN_SUBSYSTEM_DEFINITIONS = Object.freeze([
  ...
  { id: 'twin-core', area: 'digital-twin-engine', label: 'Asset Core', description: '모든 프로그램을 같은 Asset·파츠·관계·증거 형식으로 표현하는 중심 모델' },
  ...
  { id: 'twin-materialization', area: 'digital-twin-engine', label: 'Draw Map', description: '온톨로지·사실 판정과 무관하게 승인된 배치·연결선·그룹만 가시화' },
  { id: 'twin-runtime', area: 'digital-twin-engine', label: '운영 상태 관측', description: '실제 시스템 상태, 관측 시각과 LIVE·stale 판정' },
  { id: 'twin-workflow-adapter', area: 'digital-twin-engine', label: 'Workflow Canvas 어댑터', description: '현재 앱을 Asset 원장 계약에 연결하는 번역층' },
  ...
  { id: 'source-tests', area: 'testing-quality', label: '코드 구조·커넥터 검사', description: '코드 발견, 로컬 연결과 Git 동기화 회귀 테스트' },
  { id: 'engine-tests', area: 'testing-quality', label: 'Asset 원장 엔진 검사', description: '공통 모델, 어댑터, 대조와 조작 수명주기 테스트' },
